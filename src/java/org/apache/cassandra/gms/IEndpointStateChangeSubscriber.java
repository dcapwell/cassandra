...
public interface IEndpointStateChangeSubscriber
{
     ...
     */
    public default void onJoin(InetAddressAndPort endpoint, EndpointState epState) {}
    
    public default void beforeChange(InetAddressAndPort endpoint, EndpointState currentState, ApplicationState newStateKey, VersionedValue newValue) {}

    public default void onChange(InetAddressAndPort endpoint, ApplicationState state, VersionedValue value) {}

    public default void onAlive(InetAddressAndPort endpoint, EndpointState state) {}

    public default void onDead(InetAddressAndPort endpoint, EndpointState state) {}

    public default void onRemove(InetAddressAndPort endpoint) {}
     ...
     */
    public default void onRestart(InetAddressAndPort endpoint, EndpointState state) {}
}
