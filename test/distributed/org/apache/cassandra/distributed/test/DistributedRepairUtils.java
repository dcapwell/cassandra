...
public final class DistributedRepairUtils
{
    ...
    public static NodeToolResult repair(AbstractCluster<?> cluster, RepairType repairType, String... args) {
        return repair(cluster, DEFAULT_COORDINATOR, repairType, args);
    }

    public static NodeToolResult repair(AbstractCluster<?> cluster, int node, RepairType repairType, String... args) {
    ...
    public static ResultSet queryParentRepairHistory(AbstractCluster<?> cluster, int coordinator, String ks, String table)
    {
        ...
        Set<String> tableNames = ImmutableSet.of(table);
        ResultSet rs = null;
    ...
    public static void assertParentRepairFailed(AbstractCluster<?> cluster, String ks, String table)
    {
        assertParentRepairFailed(cluster, DEFAULT_COORDINATOR, ks, table);
    }

    public static void assertParentRepairFailed(AbstractCluster<?> cluster, int coordinator, String ks, String table)
    {
        ResultSet rs = queryParentRepairHistory(cluster, coordinator, ks, table);
        validateExistingParentRepair(rs, row -> {
            // check completed
            ...
            Assert.assertNotNull("Exception not found", rs.getString("exception_message"));
        });
    }
