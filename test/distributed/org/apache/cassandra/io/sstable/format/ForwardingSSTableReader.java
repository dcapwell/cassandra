...
public abstract class ForwardingSSTableReader extends SSTableReader
{
    ...
    {
        super(delegate.descriptor, Collections.emptySet(), TableMetadataRef.forOfflineTools(delegate.metadata()), delegate.maxDataAge, delegate.getSSTableMetadata(), delegate.openReason, delegate.header);
        addComponents(SSTable.componentsFor(delegate.descriptor));
